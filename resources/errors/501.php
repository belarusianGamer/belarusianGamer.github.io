<?php header("HTTP/1.0 501 Not Implemented"); ?>
<!DOCTYPE html>
<html lang="be">
  <head>
    <meta charset="utf-8">
    ...
    <title>Galactic Senate &#x7c; 501</title>
  ...
  <body onload="langCheck(), menuMode(), copyrightButton()">
    ...
    <main>
      <div class="h1block errors">
        <div>
          <h1 class="errorH1">501</h1>
          <p>Метад не падтрымліваецца:<br>сервер не падтрымлівае гэты метад HTTP запыту</p>
        </div>
      </div>
    </main>
