<?php header("HTTP/1.0 408 Request Timeout"); ?>
<!DOCTYPE html>
<html lang="be">
  <head>
    <meta charset="utf-8">
    ...
    <title>Galactic Senate &#x7c; 408</title>
  ...
  <body onload="langCheck(), menuMode(), copyrightButton()">
    ...
    <main>
      <div class="h1block errors">
        <div>
          <h1 class="errorH1">408</h1>
          <p>Скончыўся час чакання:<br>сервер не дачакаўся запыту. Праверце хуткасць інтэрнэт-спалучэння і паспрабуйце зноў</p>
        </div>
      </div>
    </main>
