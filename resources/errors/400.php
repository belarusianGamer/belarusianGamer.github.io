...
<html lang="be">
  <head>
    ...
    <title>Galactic Senate &#x7c; 400</title>
  ...
  <body onload="langCheck(), menuMode(), copyrightButton()">
    ...
    <main>
      <div class="h1block errors">
        <div>
          <h1 class="errorH1">400</h1>
          <p>Хібны запыт:<br>сервер знайшоў у ім памылку. Змяніце запыт ці перазайдзіце ў акаўнт, а потым паспрабуйце зноў</p>
        </div>
      </div>
    </main>
