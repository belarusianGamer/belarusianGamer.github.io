<?php header("HTTP/1.0 502 Bad Gateway"); ?>
<!DOCTYPE html>
<html lang="be">
  <head>
    <meta charset="utf-8">
    ...
    <title>Galactic Senate &#x7c; 502</title>
  ...
  <body onload="langCheck(), menuMode(), copyrightButton()">
    ...
    <main>
      <div class="h1block errors">
        <div>
          <h1 class="errorH1">502</h1>
          <p>Памылка шлюза:<br>сервер атрымаў хібны адказ ад вышэйпастаўленага сервера</p>
        </div>
      </div>
    </main>
